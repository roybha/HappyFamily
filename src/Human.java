...
public class Human {
  ...
  public String getName() {return this.name;}
    ...
    public  String toString(){
      return "Human{name= "+this.getName()+",surname= "+this.getSurname()+",year= "+this.getYear()+",iq= "+this.getIq()+",mother="+this.getMother().getName()+" "+this.getMother().getSurname()+",father= "+this.getFather().getName()+" "+getFather().getSurname()+", "+this.getPet().toString()+",schedule ="+ Arrays.deepToString(getSchedule())+"}";
    }
